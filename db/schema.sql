-- Trade Document Pipeline Schema (Transaction-Centric Update)
...
CREATE TABLE IF NOT EXISTS shipment_documents (
    ...
    doc_type TEXT DEFAULT 'unknown', -- 'bill_of_lading', 'commercial_invoice', 'packing_list', etc.
...
CREATE TABLE IF NOT EXISTS extraction_results (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    shipment_id TEXT NOT NULL,
    document_id TEXT,               -- Supported mapping for multi-doc lookups
    field_name TEXT NOT NULL,
    field_value TEXT,
    confidence REAL NOT NULL CHECK(confidence >= 0.0 AND confidence <= 1.0),
    extraction_method TEXT DEFAULT 'llm',  -- llm | vision_llm | tesseract | native
    FOREIGN KEY (shipment_id) REFERENCES shipments(id),
...
CREATE TABLE IF NOT EXISTS validation_results (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    shipment_id TEXT NOT NULL,
    document_id TEXT,               -- Added contextual mapping reference
    field_name TEXT NOT NULL,
...
CREATE INDEX IF NOT EXISTS idx_shipment_documents_parent ON shipment_documents(shipment_id);
CREATE INDEX IF NOT EXISTS idx_extraction_shipment ON extraction_results(shipment_id);
CREATE INDEX IF NOT EXISTS idx_extraction_document ON extraction_results(document_id);
